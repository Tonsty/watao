...
public class PotteryShaderClay extends PotteryShader{
	...
	private static final float[] specularL = new float[]{0.7f, 0.7f, 0.7f, 1.0f};
	...
	public PotteryShaderClay(String vertexShader, String fragShader, Resources resources, float offset) {
