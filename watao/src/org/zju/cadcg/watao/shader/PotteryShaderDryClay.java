...
public class PotteryShaderDryClay extends PotteryShader{
	
	//light parameter
	private static final float[] lightPosition = new float[]{-20f, 10.0f, 20f, 1.0f};
	private static final float[] ambientL = new float[]{0.6f, 0.6f, 0.6f, 1.0f};
	...
	public PotteryShaderDryClay(String vertexShader, String fragShader, Resources resources, float offset) {
