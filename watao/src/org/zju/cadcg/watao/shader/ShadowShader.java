...
public class ShadowShader extends WTShader{
	...
	//light parameter
	private float[] ambientL = new float[]{0.9f, 0.9f, 0.9f, 1.0f};
	private float[] diffuseL = new float[]{0.9f, 0.9f, 0.9f, 1.0f};
	private static final float[] lightPosition = new float[]{0.0f,15.0f,-5f, 1.0f};
	
	//material parameter
	private float[] ambientM = new float[]{0.9f, 0.9f, 0.7f, 1.0f};
	private float[] diffuseM = new float[]{0.9f, 0.9f, 0.9f, 1.0f};
